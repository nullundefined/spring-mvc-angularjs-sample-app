...
public class MealRepository {
  ...
  /*  @PersistenceContext
    ...
    public List<Meal> findMealsByDateTime(String username, Date fromDate, Date toDate,
        ...
        Meal meal = new Meal();
        meal.setCalories(Long.valueOf(12));
        meal.setDate(new Date());
        meal.setDescription("test description");
        meal.setTime(new Time(1000));
        User user = new User();
        user.setEmail("elami@com.hr");
        user.setMaxCaloriesPerDay(Long.valueOf(1200));
        user.setPasswordDigest("blabla");
    ...
    public Meal findMealById(Long id) {
        return null; //em.find(Meal.class, id);
    }
